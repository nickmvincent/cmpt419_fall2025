...
The official project deadline is **Dec 2 23:59**. If you need to make small changes up
to Dec 5, you may, but you should submit something on Dec 2.

You are encouraged to finish a draft of your project report before the end of the semester. You will also need to present your project, in some form. Assuming you clear the bar for a "good faith submission" (this is as low as speaking for 1-2 minutes with a single slide in front of the class, or preparing a short video), the marking for the presentation portion operates under an "it can only help you" rule: if your presentation helps to clarify the contributions or challenges of your project, this may positively affect your grade. In particular, presenting your project can help you increase your "relevance to class themes" score, as I will ask questions and give you a chance to further demonstrate engagement with our key themes.
...
In particular, to make the marking ecologically valid, I will incorporate elements
of academic peer review and practical resume review into the marking.

You are expected to do some degree of self or collaborative learning as part of the project. You may need to try out libraries we didn't use directly during class time or read work that wasn't assigned. If you *only* engaged with strictly required course materials, this is enough for our quizzes, but probably not be enough for the project.
...
Marking scheme: 2/2 for clear and concise abstract that explains what your project does and why you were motivated to do it. 1/2 for an abstract that is difficult to read, is vague, or doesn't motivate the work. 0/2 for an abstract that is very vague.

Look at the abstracts from our readings to remind yourself the structure of a typical "abstract".
...
You can use the visual abstract as a centerpiece in your presentation, if you like.


Marking scheme: 2/2 for clear concise visual that explains what your project does and why you were motivated to do it. 1/2 for a confusing visual. 0/2 for an visual abstract that is very vague or missing.
...
Your introduction should also concisely state what your main contributions are. What did you do – did you perform experiments, or conduct a literature review, or something else entirely? (Note that this is the contribution of your overall project, not a "contribution statement" that describes literally what each team member did. That will come later!)

The contribution statement is very important: you want your reader (and in this case, your marker) to understand "what you're going for".
...
As a rule of thumb, you should deeply engage with at least 3 pieces of related work (which again, could be something like a GitHub repo or technical blog post; but you must go beyond just listing three citations).

No requirements on citation style.
...
If you are unable to find an exemplar paper, please let us know\!
...
It is important here to give your reader an idea what you're trying to achieve and why the specific design choices you made either (1) are the best choices or (2) (more likely) are reasonable choices under the realistic constraints you made. Here, you would justify the size of your dataset, explain your compute constraints, and so on.
...
Here, you are welcome to disagree with course materials. Perhaps your project results are in tension with claims made in our readings. If so, you can describe them here.

Note: this is one aspect of your project report that you may wish to edit before sharing externally, as this “disagreement” or references to specific course readings may make less sense outside of the course project.
...
You will also earn points for producing high quality artifacts \-- this might be code, UI design mock-ups, an actual interface, or a very well formatted report. This is relative to your constraints, especially group size. 1 person = prototypes very reasonable. 10 people = it better be really polished!
...
If you don't want to present live, also include in your zip file a video.

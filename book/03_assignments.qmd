...
Next, you should complete one dry-run modeling project. You can adjust the difficulty for this, but it should involve loading a dataset, creating a test set, experimenting with more than one modeling approach, and printing more than performance metric with at least 2 visualizations (confusion matrix, precision-recall curve, etc.).
